...
-- Create a secure view (views inherit security from underlying tables)
...
COMMENT ON VIEW public.session_status_view IS 'Safe view excluding OAuth tokens. Inherits RLS from user_sessions table.';
